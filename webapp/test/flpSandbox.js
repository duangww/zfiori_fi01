			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfiorifi01-display": {
								"semanticObject": "zfiorifi01",
								"action": "display",
								"description": "抚州财务指标程序",
								"title": "抚州财务指标程序",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfiorifi01",
									"url": sap.ui.require.toUrl("zfiorifi01")
								}
							}
						}
					}
